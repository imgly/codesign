...
> **Prerelease channel.** This `develop` branch installs `@imgly/codesign-mcp@0.3.7-next.20260923142321.g3570dbd` —
...
- **Pin `@0.3.7-next.20260923142321.g3570dbd` — every recipe names that exact version on purpose.** The
...
```bash
claude mcp add codesign -- npx -y @imgly/codesign-mcp@0.3.7-next.20260923142321.g3570dbd stdio
```
...
```bash
codex mcp add codesign -- npx -y @imgly/codesign-mcp@0.3.7-next.20260923142321.g3570dbd stdio
```
...
```bash
agy mcp add codesign -- npx -y @imgly/codesign-mcp@0.3.7-next.20260923142321.g3570dbd stdio
```
...
```json
{
  "mcpServers": {
    "codesign": {
      ...
      "args": [
        "-y",
        "@imgly/codesign-mcp@0.3.7-next.20260923142321.g3570dbd",
        "stdio"
      ]
    }
  }
