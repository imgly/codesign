...
> **Prerelease channel.** This `develop` branch installs `@imgly/codesign-mcp@0.3.7-next.20260926104913.gd00e34c` —
...
- **Pin `@0.3.7-next.20260926104913.gd00e34c` — every recipe names that exact version on purpose.** The
...
```bash
claude mcp add codesign -- npx -y @imgly/codesign-mcp@0.3.7-next.20260926104913.gd00e34c stdio
```
...
```bash
codex mcp add codesign -- npx -y @imgly/codesign-mcp@0.3.7-next.20260926104913.gd00e34c stdio
```
...
```bash
agy mcp add codesign -- npx -y @imgly/codesign-mcp@0.3.7-next.20260926104913.gd00e34c stdio
```
...
```json
{
  "mcpServers": {
    "codesign": {
      ...
      "args": [
        "-y",
        "@imgly/codesign-mcp@0.3.7-next.20260926104913.gd00e34c",
        "stdio"
      ]
    }
  }
