...
> **Prerelease channel.** This `develop` branch installs `@imgly/codesign-mcp@0.3.7-next.20260923175422.g6696ad5` —
...
- **Pin `@0.3.7-next.20260923175422.g6696ad5` — every recipe names that exact version on purpose.** The
...
```bash
claude mcp add codesign -- npx -y @imgly/codesign-mcp@0.3.7-next.20260923175422.g6696ad5 stdio
```
...
```bash
codex mcp add codesign -- npx -y @imgly/codesign-mcp@0.3.7-next.20260923175422.g6696ad5 stdio
```
...
```bash
agy mcp add codesign -- npx -y @imgly/codesign-mcp@0.3.7-next.20260923175422.g6696ad5 stdio
```
...
```json
{
  "mcpServers": {
    "codesign": {
      ...
      "args": [
        "-y",
        "@imgly/codesign-mcp@0.3.7-next.20260923175422.g6696ad5",
        "stdio"
      ]
    }
  }
