...
> **Prerelease channel.** This `develop` branch installs `@imgly/codesign-mcp@0.3.7-next.20260926064901.gb45fd3c` —
...
- **Pin `@0.3.7-next.20260926064901.gb45fd3c` — every recipe names that exact version on purpose.** The
...
```bash
claude mcp add codesign -- npx -y @imgly/codesign-mcp@0.3.7-next.20260926064901.gb45fd3c stdio
```
...
```bash
codex mcp add codesign -- npx -y @imgly/codesign-mcp@0.3.7-next.20260926064901.gb45fd3c stdio
```
...
```bash
agy mcp add codesign -- npx -y @imgly/codesign-mcp@0.3.7-next.20260926064901.gb45fd3c stdio
```
...
```json
{
  "mcpServers": {
    "codesign": {
      ...
      "args": [
        "-y",
        "@imgly/codesign-mcp@0.3.7-next.20260926064901.gb45fd3c",
        "stdio"
      ]
    }
  }
