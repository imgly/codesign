...
- [Create Shapes](./stickers-and-shapes/create-edit/create-shapes.md) - Learn how to programmatically create and configure shapes in CE.SDK for server-side Node.js applications.
