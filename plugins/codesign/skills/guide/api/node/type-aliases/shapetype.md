...
Refer to [ShapeTypeShorthand](./api/node/type-aliases/shapetypeshorthand.md) and [ShapeTypeLonghand](./api/node/type-aliases/shapetypelonghand.md) for more details.
