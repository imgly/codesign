...
- [Insert Shapes or Stickers](./insert-media/shapes-or-stickers.md) - Add shapes and stickers to your designs using CE.SDK in a Node.js environment. Create rectangles, ellipses, stars, polygons, lines, and custom vector paths programmatically.
